...
@Suite("Xbox360 Parser Tests") struct Xbox360ParserTests {
  ...
  @Test("Input report with invalid length byte returns empty array")
  func invalidLengthByteReturnsEmpty() throws {
    let parser = Xbox360Parser()
  ...
  @Test("All-zero input report returns no synthetic events")
  func allZeroReportReturnsNoSyntheticEvents() throws {
    let parser = Xbox360Parser()
